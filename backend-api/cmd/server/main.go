	...
	api := r.Group("/api/v1")
	{
		...
		api.GET("/app/version", func(c *gin.Context) {
			c.JSON(200, gin.H{
				"version":       "1.0.3",
				"build_number":  4,
				"download_url":  "https://github.com/skjftp/tripund-ecommerce/releases/download/v1.0.3/tripund-v1.0.3.apk",
				"release_notes": "🚀 Version 1.0.3 - Major Fixes!\n✅ Featured products now loading correctly\n✅ Category products properly filtered\n✅ Navigation buttons fixed (Cart/Wishlist)\n✅ Profile section screens added\n✨ Orders, Addresses, Payment Methods\n✨ Notification settings\n✨ Help & Support section\n🔧 Improved API integration",
				"force_update":  false,
				"min_version":   "1.0.0",
			})
		})
