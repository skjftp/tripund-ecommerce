...
// getElegantOrderTemplate returns the elegant order confirmation template
func (h *EmailTemplateHandler) getElegantOrderTemplate() string {
	return `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
// getMinimalOrderTemplate returns the minimal order confirmation template
func (h *EmailTemplateHandler) getMinimalOrderTemplate() string {
	return `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
// getFestiveOrderTemplate returns the festive order confirmation template
func (h *EmailTemplateHandler) getFestiveOrderTemplate() string {
	return `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
// getModernShippingTemplate returns the modern shipping confirmation template
func (h *EmailTemplateHandler) getModernShippingTemplate() string {
	return `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
